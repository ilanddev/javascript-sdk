...
import { VmConfigurationLimits } from '../../model/location/vm-configuration-limits';
import { VmConfigurationLimitsJson } from '../../model/location/__json__/vm-configuration-limits-json';
...
export class LocationService {
   ...
   */
  /* istanbul ignore next: autogenerated */
  static async getVmConfigurationLimits(location: string): Promise<VmConfigurationLimits> {
    return Iland.getHttp().get(`/locations/${location}/vm-configuration-limits`).then((response) => {
      const json = response.data as VmConfigurationLimitsJson;
      return new VmConfigurationLimits(json);
    });
  }
}
