...
export const MockVirtualDisk1: VirtualDiskJson = {
  name: 'test disk 1',
  size: 500,
  type: 'LSI_LOGIC'
};

export const MockVirtualDisk2: VirtualDiskJson = {
  name: 'test disk 2',
  size: 1000,
  type: 'BUS_LOGIC'
};

export const MockVirtualDisks: Array<VirtualDiskJson> = [MockVirtualDisk1, MockVirtualDisk2];
