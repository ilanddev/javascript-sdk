...
import {
    ...
    CloudRepositoryJson,
    WanAcceleratorJson,
    UpgradeTenantContractRequestJson,
    CloudTenantBackupHistoryJson,
    VccPerfSampleJson
} from './json/cloud-tenant';
import { Iland } from '../iland';
import { EntityType } from './json/entity-type';
import { PerfIntervalType } from './json/perf-interval-type';
...
export class WanAccelerator {
   ...
   * @returns {WanAcceleratorJson} the API json object
   */
...
export class CloudRepository {
  ...
  /**
   * Gets the raw JSON object from the API.
   * @returns {CloudRepositoryJson} the API json object
   */
...
export class CloudTenantResource {
  ...
  /**
   * Gets the raw JSON object from the API.
   * @returns {CloudTenantResourceJson} the API json object
   */
...
export class CloudTenant extends Entity {
  ...
  /**
   * Gets the raw JSON object from the API.
   * @returns {CloudTenantJson} the API json object
   */
  ...
  async getStorageUsageFor(start: number, end: number, limit: number,
    ...
    return Iland.getHttp().get(`/cloud-tenants/${this.uuid}/p`, {
      params: {
        start: start,
        end: end,
        limit: limit,
   ...
   * @param {UpgradeTenantContractRequestJson} contract
   * @returns {Promise<any>}
   */
