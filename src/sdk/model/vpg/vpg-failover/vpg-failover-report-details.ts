import {
    BootOrderSettingsJson, DetailedRecoveryStepJson, NetworkMappingJson, VmRecoverySettingsJson,
    VpgFailoverReportDataJson,
    VpgFailoverReportDetailsJson
} from './__json__/vpg-failover-report-detail';
import { Status } from './__json__/vpg-failover-status-type';
