...
export class DisasterRecoveryRunbook {
  ...
  /**
   * Refreshes the Disaster Recovery Runbook data by retrieving it from the API again.
  ...
  async refresh(): Promise<DisasterRecoveryRunbook> {
    return Iland.getHttp().get(`/orgs/${this.orgUuid}/disaster-recovery-runbooks/${this.uuid}`).then((response) => {
