...
export class Org extends Entity {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async createVdiTeam(uuid: string, teamData: VdiTeamUpdateRequest): Promise<VdiTeam> {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async createVdiUser(uuid: string, userData: VdiUserUpdateRequest): Promise<VdiUser> {
  ...
  async getVdiAutomationDeployment(automationGroupUuid: string, deploymentUuid: string):
      Promise<Array<VdiAutomationDeployment>> {
