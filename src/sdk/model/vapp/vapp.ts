...
import {
  VappIntegratedBackupStatusDetailJson
} from '../integrated-backups/integrated-backup-status/__json__/vapp-integrated-backup-status-detail-json';
import {
  VappIntegratedBackupStatusDetail
} from '../integrated-backups/integrated-backup-status/vapp-integrated-backup-status-detail';
...
import { VappBackupStatusDetail } from '../advanced-backups/backup-status/vapp-backup-status-detail';
import { VappBackupStatusDetailJson } from '../advanced-backups/backup-status/__json__/vapp-backup-status-detail-json';
...
export class Vapp extends Entity implements EntityWithPerfSamples {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getIntegratedBackupStatus(): Promise<VappIntegratedBackupStatusDetail> {
    return Iland.getHttp().get(`/vapps/${this.uuid}/integrated-backup-status`).then((response) => {
      const json = response.data as VappIntegratedBackupStatusDetailJson;
      return new VappIntegratedBackupStatusDetail(json);
    });
  }
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getBackupStatus(): Promise<VappBackupStatusDetail> {
    return Iland.getHttp().get(`/vapps/${this.uuid}/backup-status`).then((response) => {
      const json = response.data as VappBackupStatusDetailJson;
      return new VappBackupStatusDetail(json);
    });
  }
}
