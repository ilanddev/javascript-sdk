...
import { O365OrgCreateModifyRequest } from './o365-org-create-modify-request';
...
export class O365Organization extends Entity {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getOrgUsers(page?: number, pageSize?: number, searchUser?: string): Promise<Array<O365User>> {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async modifyCredentials(request: O365OrgCreateModifyRequest): Promise<unknown> {
  ...
  async getO365DeviceCode(): Promise<O365DeviceCode> {
    return Iland.getHttp().get(`/o365-organizations/${this.uuid}/actions/get-o365-device-code`)
        .then((response) => {
