import { DistributedFirewallLayer3RuleJson } from './__json__/distributed-firewall-layer3-rule-json';
...
export class DistributedFirewallLayer3Rule {
  ...
  constructor(private _json: DistributedFirewallLayer3RuleJson) {
  }
