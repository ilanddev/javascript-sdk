...
export class Company extends Entity {
   ...
   * @param {number} offset Page offset for return documents
   * @param {number} limit Limit to number of hits (default value is 10 and maximum is 50)
   * @returns {Promise<SearchResult>} a promise that resolves with a SearchResult
   */
  /* istanbul ignore next: autogenerated */
  async search(query?: string, offset?: number, limit?: number): Promise<SearchResult> {
