...
import { O365OrgCreateModifyRequest } from '../o365/o365-org-create-modify-request';
...
import { O365DeviceCode } from './o365-device-code';
...
export class Company extends Entity {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getO365DeviceCode(locationId: string): Promise<O365DeviceCode> {
    return Iland.getHttp().get(`/companies/${this.uuid}/location/${locationId}/actions/get-o365-device-code`)
        .then((response) => {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async createO365Organization(
    locationUuid: string,
    creationRequest: O365OrgCreateModifyRequest
  ): Promise<O365Organization> {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getIdentityProviderRedirectUri(): Promise<String> {
    return Iland.getHttp().get(`/companies/${this.uuid}/idp-redirect-uri`).then((response) => {
