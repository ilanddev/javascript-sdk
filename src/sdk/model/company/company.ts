...
export class Company extends Entity {
  ...
  async getCloudTenants(location: string): Promise<Array<CloudTenant>> {
    return Iland.getHttp().get(`/companies/${this.uuid}/location/${location}/vcc-backup-tenants`).then((response) => {
  ...
  /**
   * Get regarding options.
   * @returns {Array<SupportRegardingOption>}
   */
  /* istanbul ignore next: autogenerated */
  async getRegardingOptions(): Promise<Array<SupportRegardingOption>> {
