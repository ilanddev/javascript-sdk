...
import { ContactType, Severity, SupportTicketCreateRequestJson } from './__json__/support-ticket-create-request-json';
...
export class SupportTicketCreateRequest {
  ...
  constructor(summary: string, description: string, ccEmailAddresses: Array<string>, ccEmailsEnabled: boolean,
              regardingId: number, serviceId: number, categoryId: number, severity: Severity, contactType: ContactType,
              phoneNumber: string, phoneNumberExt: string);
  constructor(firstParam: string | SupportTicketCreateRequest | SupportTicketCreateRequestJson, description?: string,
              ...
              categoryId?: number, severity?: Severity, contactType?: ContactType, phoneNumber?: string,
