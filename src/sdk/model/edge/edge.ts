...
import {
  EdgeGatewayFirewallSourceObjectListJson
} from './edge-gateway-firewall/__json__/edge-gateway-firewall-source-object-list-json';
import {
...
import { EdgeGatewayFirewallSourceObjectList } from './edge-gateway-firewall/edge-gateway-firewall-source-object-list';
...
export class Edge extends Entity {
   ...
   * @returns {Promise<EdgeGatewayFirewallSourceObjectList>}
   */
  /* istanbul ignore next: autogenerated */
  async getFirewallSourceObjects(type: string | EdgeGatewayFirewallObjectType,
                                 ...
                                 pageSize?: number): Promise<EdgeGatewayFirewallSourceObjectList> {
    let _type = type;
    ...
    return Iland.getHttp().get(`/edge-gateways/${this.uuid}/firewall/sources/${_type}`, {
      ...
      const json = response.data.data as EdgeGatewayFirewallSourceObjectListJson;
      return new EdgeGatewayFirewallSourceObjectList(json);
    });
  }
}
