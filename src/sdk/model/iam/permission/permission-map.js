...
var PermissionsMap = (function () {
    function PermissionsMap() {
        ...
        this._permissions.set('MANAGE_ILAND_BACKUP_DATA_CENTER_STORAGE', (new permission_1.Permission('MANAGE_ILAND_BACKUP_DATA_CENTER_STORAGE', 'VCC_BACKUP_LOCATION', 'WRITE', true, false, ['MANAGE_ILAND_BACKUP_TENANT_STORAGE'])));
        ...
        this._permissions.set('VIEW_ILAND_CLOUD_VAPP', (new permission_1.Permission('VIEW_ILAND_CLOUD_VAPP', 'IAAS_VAPP', 'READ', true, true, ['VIEW_ILAND_CLOUD_VM', 'VIEW_ILAND_CLOUD_VAPP_NETWORK'])));
        ...
        this._permissions.set('MANAGE_ILAND_CLOUD_VAPP_POWER_STATE', (new permission_1.Permission('MANAGE_ILAND_CLOUD_VAPP_POWER_STATE', 'IAAS_VAPP', 'WRITE', true, false, ['MANAGE_ILAND_CLOUD_VM_POWER_STATE'])));
        ...
        this._permissions.set('VIEW_ILAND_CLOUD_VDC', (new permission_1.Permission('VIEW_ILAND_CLOUD_VDC', 'IAAS_VDC', 'READ', true, true, ['VIEW_ILAND_CLOUD_VAPP', 'VIEW_ILAND_CLOUD_EDGE',
        ...
        this._permissions.set('VIEW_ILAND_CLOUD_CATALOG', (new permission_1.Permission('VIEW_ILAND_CLOUD_CATALOG', 'IAAS_CATALOG', 'READ', true, true, ['VIEW_ILAND_CLOUD_VAPP_TEMPLATE', 'VIEW_ILAND_CLOUD_MEDIA'])));
        ...
        this._permissions.set('VIEW_ILAND_CLOUD_ORG', (new permission_1.Permission('VIEW_ILAND_CLOUD_ORG', 'IAAS_ORGANIZATION', 'READ', true, true, ['VIEW_ILAND_CLOUD_VDC', 'VIEW_ILAND_CLOUD_CATALOG',
        ...
        this._permissions.set('MANAGE_ILAND_CLOUD_ORG_SECURITY', (new permission_1.Permission('MANAGE_ILAND_CLOUD_ORG_SECURITY', 'IAAS_ORGANIZATION', 'WRITE', true, false, ['VIEW_ILAND_CLOUD_ORG_SECURITY'])));
        ...
        this._permissions.set('MANAGE_ILAND_CLOUD_ORG_DR_RUNBOOKS', (new permission_1.Permission('MANAGE_ILAND_CLOUD_ORG_DR_RUNBOOKS', 'IAAS_ORGANIZATION', 'WRITE', true, false, ['VIEW_ILAND_CLOUD_ORG_DR_RUNBOOKS',
        ...
        this._permissions.set('VIEW_ILAND_BACKUP_BILLING', (new permission_1.Permission('VIEW_ILAND_BACKUP_BILLING', 'VCC_BACKUP_PRODUCT', 'READ', true, false, ['VIEW_ILAND_BACKUP_LOCATION_BILLING'])));
        ...
        this._permissions.set('MANAGE_ILAND_OBJECT_STORAGE', (new permission_1.Permission('MANAGE_ILAND_OBJECT_STORAGE', 'OBJECT_STORAGE_PRODUCT', 'WRITE', true, false, ['MANAGE_ILAND_OBJECT_STORAGE_LOCATION'])));
