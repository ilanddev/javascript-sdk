  ...
  private constructor() {
    ...
    this._permissions.set('MANAGE_ILAND_BACKUP_TENANT_PASSWORD',
      (new Permission('MANAGE_ILAND_BACKUP_TENANT_PASSWORD', 'VCC_BACKUP_TENANT', 'WRITE', true,
        false, null)));
    this._permissions.set('MANAGE_ILAND_BACKUP_TENANT',
      (new Permission('MANAGE_ILAND_BACKUP_TENANT', 'VCC_BACKUP_TENANT', 'WRITE', true,
        false, null)));
    ...
    this._permissions.set('MANAGE_ILAND_CLOUD_EDGE_CERTIFICATE_CONFIGURATION',
        (new Permission('MANAGE_ILAND_CLOUD_EDGE_CERTIFICATE_CONFIGURATION', 'IAAS_EDGE', 'WRITE', true,
            false, null)));
    this._permissions.set('MANAGE_ILAND_CLOUD_EDGE_SETTINGS_CONFIGURATION',
        (new Permission('MANAGE_ILAND_CLOUD_EDGE_SETTINGS_CONFIGURATION', 'IAAS_EDGE', 'WRITE', true,
            false, null)));
    this._permissions.set('MANAGE_ILAND_CLOUD_EDGE_SSL_VPN_CONFIGURATION',
        (new Permission('MANAGE_ILAND_CLOUD_EDGE_SSL_VPN_CONFIGURATION', 'IAAS_EDGE', 'WRITE', true,
            false, null)));
    ...
    this._permissions.set('CREATE_ILAND_OBJECT_STORAGE_USER_SESSION',
      (new Permission('CREATE_ILAND_OBJECT_STORAGE_USER_SESSION', 'OBJECT_STORAGE_CEPH_TENANT', 'READ', true,
        false, null))),
    this._permissions.set('CREATE_ILAND_OBJECT_STORAGE_KEY',
      (new Permission('CREATE_ILAND_OBJECT_STORAGE_KEY', 'OBJECT_STORAGE_CEPH_TENANT', 'WRITE', true,
        false, null))),
    this._permissions.set('DELETE_ILAND_OBJECT_STORAGE_KEY',
      (new Permission('DELETE_ILAND_OBJECT_STORAGE_KEY', 'OBJECT_STORAGE_CEPH_TENANT', 'WRITE', true,
        false, null))),
    this._permissions.set('VIEW_ILAND_CEPH_OBJECT_STORAGE_TENANT',
      (new Permission('VIEW_ILAND_CEPH_OBJECT_STORAGE_TENANT', 'OBJECT_STORAGE_CEPH_TENANT', 'READ', true,
        false, null))),
    this._permissions.set('MANAGE_ILAND_CEPH_OBJECT_STORAGE',
      (new Permission('MANAGE_ILAND_CEPH_OBJECT_STORAGE', 'OBJECT_STORAGE_CEPH_TENANT', 'WRITE', true,
        false, ['CREATE_ILAND_OBJECT_STORAGE_USER_SESSION',
    ...
    this._permissions.set('VIEW_ILAND_CEPH_OBJECT_STORAGE_LOCATION',
      (new Permission('VIEW_ILAND_CEPH_OBJECT_STORAGE_LOCATION', 'OBJECT_STORAGE_CEPH_LOCATION', 'READ', true,
        false, null))),
    ...
    this._permissions.set('CREATE_ILAND_BACKUP_TENANT',
      (new Permission('CREATE_ILAND_BACKUP_TENANT', 'COMPANY', 'WRITE', true,
        false, null)));
  }
